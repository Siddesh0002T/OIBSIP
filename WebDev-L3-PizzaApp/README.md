![Pizza Delivery Platform Banner](./assets/screenshots/top_banner.svg)
...
*   **Repository Naming Convention:** `OIBSIP/WebDev-L3-PizzaApp` _(Strictly adhered to official onboarding guidelines)_
...
![Pizza Delivery Platform UI Showcase](./assets/screenshots/project_showcase.svg)
...
_(Note: Replace Razorpay and SMTP credentials with your test keys / app passwords as needed)._
...
![Siddhesh More OIBSIP Offer Letter](./assets/certificates/Siddhesh%20More%20_Offer_Letter.svg)

### 🎓 Internship Completion Certificate & Recommendation Letter

Official completion certificate and appreciation letter status:

![Certificate Coming Soon](./assets/certificates/certificate_coming_soon.svg)
...
![Siddhesh More - OIBSIP Banner](./assets/screenshots/end_banner.svg)